/**
            ...
            i190642, i190428, i190440, i190447

            ONLINE CLOTHING STORE : CLOTHAHOLIC
*/
...
class Handler 
{
    ...
    getBagButtons()
    {
        ...
        buttons.forEach(button => {
            ...
            console.log("-- USER STORY : ADD TO CART --")
    ...
    getWishlistButtons()
    {
        ...
        buttons.forEach(button => {
            ...
            console.log("-- USER STORY : ADD TO WISHLIST --")
            if(inWishlist)
            {
                // Show message, disable the button
    ...
    cartLogic()
    {
        ...
        clearCartButton.addEventListener('click', () => {
            console.log("-- USER STORY - CLEAR CART --")
            this.clearCart()
        })

        cartContent.addEventListener('click', event => {
            console.log("-- USER STORY - REMOVE FROM CART --")
            ...
            products.getProducts().then( products =>   
                {
                    ...
                    ClothStore.displayProducts(products) 
                    // Locally storing items in the cart
                    Inventory.saveProducts(products)
                }).then(() => {
                    ClothStore.getBagButtons()
                    ClothStore.cartLogic()
                    ClothStore.getWishlistButtons()
                    ClothStore.wishlistLogic()
                })
        })
    }
}
